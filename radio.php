...
<div class="menu-bar">
	<h2 style="text-align:center;font-family:algerian;font-size:300%;">St.Joseph's College Trichy</h2></div>
<body>
...
<center>
 <form enctype="multipart/form-data" method="post" action="radio1.php">
 <table id="demo">
  <tr>
...
?>
<tr>
<td><center><input type="radio" value="<?php echo $row['dno1']; ?>" name="vote" checked ></center></td>
